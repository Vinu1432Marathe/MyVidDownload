...
import com.clipcatcher.video.highspeed.savemedia.download.Adapter.CaptionListAdapter.AdViewHolder
import com.clipcatcher.video.highspeed.savemedia.download.Adapter.CaptionListAdapter.DataViewHolder
import com.clipcatcher.video.highspeed.savemedia.download.R

class CoolBioAdapter(var activity: Activity, private val items: List<String>) :
    ...
    private fun mergeDataWithAds(items: List<String>) {
        ...
        for (item in items) {
            ...
            if (count == nextAdPosition) {
                ...
                nextAdPosition += 5 // Next ad after every 5 items
            }
        }
    }
    ...
    class BioViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_AD) {
            ...
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_cool_bio, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (getItemViewType(position) == TYPE_AD) {
            ...
            val captionHolder = holder as BioViewHolder
...
//            val intent =
//                Intent(activity, CopyDataActivity::class.java).putExtra("CopyData", items[position])
//            UtilsClass.startSpecialActivity(activity, intent, false);
//        }
